# Arandu 0.1.0-rc.4 — relatório de promoção
...
cargo run --locked -p xtask -- check-release-contract v0.1.0-rc.4
git tag -a v0.1.0-rc.4 -m "Arandu 0.1.0-rc.4"
...
- [ ] Artifact `rc-evidence-v0.1.0-rc.4` preservado.
