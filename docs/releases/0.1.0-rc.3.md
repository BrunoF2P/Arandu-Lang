# Arandu 0.1.0-rc.3 — relatório de promoção
...
cargo run --locked -p xtask -- check-release-contract v0.1.0-rc.3
git tag -a v0.1.0-rc.3 -m "Arandu 0.1.0-rc.3"
...
- [ ] Artifact `rc-evidence-v0.1.0-rc.3` preservado.
