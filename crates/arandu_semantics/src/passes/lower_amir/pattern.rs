    ...
    pub(crate) fn lower_condition(
        ...
        match cond {
            ...
            HirCondition::Is { expr, pattern } => {
                ...
                self.lower_pattern_match(scrutinee, pattern, symbols)
            }
        }
    }
    ...
    pub(crate) fn lower_pattern_match(
        ...
        match pattern {
            ...
            HirPattern::Literal { expr: lit_expr, .. } => {
                let lit_op = self.lower_expr(lit_expr, None, symbols)?;
            ...
            HirPattern::Struct {
                ...
                for field in fields {
                    ...
                    let item_matches = if let Some(pat) = &field.pattern {
